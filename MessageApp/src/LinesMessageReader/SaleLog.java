...
public class SaleLog {
	...
	/*
	 * Format the report with right padding structure. populates product details
	 * on each line.
	 */
	public void formatReports(String type, Product product) {

		String lineItem = String.format("|%-30s|%-11d|%-11.2f|", product.getProductType(), product.getTotalQuantity(),
	...
	public void report() {
		...
		if ((normalReports.size() % 10) == 0 && normalReports.size() != 0) {
			...
			System.out.println("|LinesMessageReader.Product    |Quantity   |Value      |");
