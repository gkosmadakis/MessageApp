...
public class MessageParser {
	...
	/*
	 * Constructor on initialisation parses the product details.
	 */
	...
	/*
	 * Validates the message and identifies the message type to get it parsed
	 * properly to obtain product details.
	 * 
	...
	/*
	 * Just to handle the plural cases of the fruit products Made under the
	 * assumption that no other sale items will be given. e.g Tumbler, Plates.
	 * etc.
	 * 
	...
	/* Getter methods. Get the product type */
